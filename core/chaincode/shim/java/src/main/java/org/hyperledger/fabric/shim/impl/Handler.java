...
import org.hyperledger.fabric.shim.SecurityContext;
		...
		new Thread(() -> {
			try {
				...
				try
				{
					...
					securityCert = new SecurityContext(sid.getIdBytes(), ByteString.copyFromUtf8(""), chr.getTimestamp(),chainCodeName);
