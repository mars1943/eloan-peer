...
func (stub *MockStub) Add(rlistName string, id string) {

}
func (stub *MockStub) AddByIndex(rlistName string, nIndex int, id string) {

}
func (stub *MockStub) Remove(rlistName string, id string) {

}
func (stub *MockStub) Size(rlistName string) int {
	return 0
}
func (stub *MockStub) Get(rlistName string, nIndex int) string {
	return ""
}
func (stub *MockStub) IndexOf(rlistName string, id string) int {
	return -1
}
func (stub *MockStub) QueryStateHistory(idKey string) []byte {
	return nil
}
