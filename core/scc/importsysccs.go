...
import (
	...
	//rongzer 王剑增加
	"github.com/hyperledger/fabric/core/scc/rbcapproval"
...
var systemChaincodes = []*SystemChaincode{
	...
	//rongzer,王剑增加
	{
		Enabled:           true,
		Name:              "rbccustomer",
		Path:              "github.com/hyperledger/fabric/core/chaincode/rbccustomer",
		InitArgs:          [][]byte{[]byte("")},
	...
	},
	{
		Enabled:           true,
		Name:              "rbcapproval",
		Path:              "github.com/hyperledger/fabric/core/chaincode/rbcapproval",
		InitArgs:          [][]byte{[]byte("")},
